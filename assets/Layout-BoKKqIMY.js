...
const _t = ["top", "right", "bottom", "left"],
                            ...
                            d(
                                ...
                                [
                                    ...
                                    d(
                                        "p",
                                        {
                                            class: "mt-4 cursor-pointer bg-white text-black rounded-lg font-black py-2 text-[12px] text-center",
                                            onClick:
                                                u[0] ||
                                                (u[0] = (f) =>
                                                    L(l).push(
    ...
    ao = d("p", null, "AirBuddy for v2Board 主题", -1),
            ...
            return (n, a) => (
                ...
                T(
                    ...
                    [
                        ao,
                        d("div", lo, [
                            s(L(R), { width: 24, icon: "logos:telegram" }),
                            ro,
                        ]),
                        so,
                    ],
