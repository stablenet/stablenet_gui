            ...
            if (!e) n = o;
                ...
                (i = i.replace(/\B(?=(\d{3})+(?!\d))/g, l)),
                    ...
                    (n = [
                        w(
                            "span",
                            { key: "int", class: `${h}-content-value-int` },
                            [s, i]
                        ),
                        f &&
                            w(
...
J.install = function (t) {
    return (
        t.component(J.name, J), t.component(J.Countdown.name, J.Countdown), t
    );
};
        ...
        return {
            [r]: O(O({}, Ht(t)), {
                ...
                [`& > ${r}-mask`]: {
                    ...
                    textAlign: "center",
                    [`& > ${r}-expired , & > ${r}-scanned`]: {
                        color: t.QRCodeTextColor,
                    },
                },
                "&-icon": {
                    marginBlockEnd: t.marginXS,
                    fontSize: t.controlHeight,
                },
            }),
...
(function (t) {
    class r {
        ...
        static encodeSegments(n, o) {
            ...
            const y = [];
            for (const S of n) {
                a(S.mode.modeBits, 4, y),
                    a(S.numChars, S.mode.numCharCountBits(u), y);
        ...
        drawFormatBits(n) {
            ...
            for (let i = 9; i < 15; i++)
                this.setFunctionModule(14 - i, 8, c(s, i));
            for (let i = 0; i < 8; i++)
        ...
        drawVersion() {
            ...
            for (let e = 0; e < 18; e++) {
                const s = c(o, e),
                    i = this.size - 11 + (e % 3),
                    f = Math.floor(e / 3);
                this.setFunctionModule(i, f, s),
                    this.setFunctionModule(f, i, s);
            }
        }
        ...
        drawCodewords(n) {
            if (
                n.length != Math.floor(r.getNumRawDataModules(this.version) / 8)
            )
                throw new RangeError("Invalid argument");
            let o = 0;
            for (let e = this.size - 1; e >= 1; e -= 2) {
                ...
                for (let s = 0; s < this.size; s++)
                    for (let i = 0; i < 2; i++) {
                        ...
                        !this.isFunction[v][f] &&
                            o < n.length * 8 &&
                            ((this.modules[v][f] = c(n[o >>> 3], 7 - (o & 7))),
                            o++);
                    }
            }
            d(o == n.length * 8);
            ...
            for (let o = 0; o < this.size; o++)
                for (let e = 0; e < this.size; e++) {
                    ...
                    switch (n) {
                        ...
                        case 4:
                            s =
                                (Math.floor(e / 3) + Math.floor(o / 2)) % 2 ==
                                0;
                            break;
                        case 5:
                            s = ((e * o) % 2) + ((e * o) % 3) == 0;
                ...
                for (let y = 0; y < this.size; y++)
                    this.modules[i][y] == f
                        ...
                        : (this.finderPenaltyAddHistory(u, v),
                          f ||
                              (n +=
                                  this.finderPenaltyCountPatterns(v) *
                                  r.PENALTY_N3),
                          (f = this.modules[i][y]),
                          (u = 1));
                n +=
                    this.finderPenaltyTerminateAndCount(f, u, v) * r.PENALTY_N3;
            }
            for (let i = 0; i < this.size; i++) {
                let f = !1,
                    u = 0;
            ...
            if (this.version == 1) return [];
            {
                const n = Math.floor(this.version / 7) + 2,
                    o =
                        this.version == 32
                            ? 26
                            : Math.ceil((this.version * 4 + 4) / (n * 2 - 2)) *
                              2,
                    e = [6];
                for (let s = this.size - 7; e.length < n; s -= o)
                    e.splice(1, 0, s);
                return e;
            }
        }
        ...
        static reedSolomonComputeRemainder(n, o) {
            ...
            for (const s of n) {
                const i = s ^ e.shift();
                e.push(0),
                    o.forEach((f, u) => (e[u] ^= r.reedSolomonMultiply(f, i)));
            }
            return e;
        }
    ...
    class l {
        ...
        static makeAlphanumeric(n) {
            ...
            for (e = 0; e + 2 <= n.length; e += 2) {
                ...
                (s += l.ALPHANUMERIC_CHARSET.indexOf(n.charAt(e + 1))),
                    a(s, 11, o);
            }
            return (
                e < n.length &&
                    a(l.ALPHANUMERIC_CHARSET.indexOf(n.charAt(e)), 6, o),
        ...
        static toUtf8ByteArray(n) {
            ...
            for (let e = 0; e < n.length; e++)
                n.charAt(e) != "%"
                    ...
                    : (o.push(parseInt(n.substring(e + 1, e + 3), 16)),
                      (e += 2));
            return o;
        }
    }
    ...
    return (
        t.forEach(function (c, d) {
            ...
            c.forEach(function (h, n) {
                if (!h && l !== null) {
                    a.push(`M${l + r} ${d + r}h${n - l}v1H${l + r}z`),
                        (l = null);
                    return;
                }
                if (n === c.length - 1) {
...
const cn = (function () {
    ...
    Ce = function () {
        const t = (r, a) =>
            Object.defineProperty(Uint8Array.prototype, r, ye(a));
        t("toBase64", function (r) {
            return bt(this, r);
        }),
            t("toBase64URI", function () {
                ...
                c = Et(() => {
                    ...
                    return (
                        h &&
                            l.plan &&
                            ((e =
                                ((u = l == null ? void 0 : l.plan) == null
                                    ? void 0
                                    : u.name) || "未知"),
                            (s =
                                ((l == null ? void 0 : l.expired_at) || 0) *
                                1e3),
                ...
                return (
                    ...
                    Y(
                        ...
                        [
                            l.full
                                ? q("", !0)
                                : (N(), yt(le, { key: 0, name: "我的订阅" })),
                            E(
                                "div",
                                {
                                    "aria-hidden": l.full,
                                    class: V(l.$style.cardContainer),
                                },
                                [
                            ...
                            w(
                                o,
                                {
                                    ...
                                    "onUpdate:open":
                                        h[6] ||
                                        (h[6] = (e) =>
                                            (d.value.actionShow = e)),
                                    class: V(l.$style.subscribeContainer),
                                    closable: !1,
                                    footer: null,
                                },
                                {
                                    default: ft(() => [w(Yn, { code: !0 })]),
                                    _: 1,
                                },
                                8,
                                ["open", "class"]
                            ...
                            w(
                                o,
                                {
                                    ...
                                    "onUpdate:open":
                                        h[7] ||
                                        (h[7] = (e) => (d.value.planShow = e)),
                                    "cancel-text": "取消",
                                    "ok-text": "确定",
                                    title: "确定要重置当月流量？",
                                    onOk:
                                        h[8] ||
                                        (h[8] = (e) => d.value.planOK()),
                                },
                                { default: ft(() => [po]), _: 1 },
                                8,
                                ["open"]
